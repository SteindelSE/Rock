...
namespace RockWeb.Blocks.Utility
{
    ...
    [DisplayName( "Small Group List (Legacy)" )]
    [Category( "Groups" )]
    [Description( "List block to display a list of small groups." )]
    [LinkedPage("Detail Page", "", true, "", "", 0)]
    [Rock.SystemGuid.BlockTypeGuid( "88EDCEC9-B71E-4BB3-B712-6B5051AE356D" )]
    public partial class SmallGroupList : RockBlock, ICustomGridColumns
    {
        ...
        protected override void OnInit( EventArgs e )
        {
            ...
            this.AddConfigurationUpdateTrigger( upnlSmallGroupsList );
        }
        ...
        protected void gGroup_RowSelected( object sender, RowEventArgs e )
        {
